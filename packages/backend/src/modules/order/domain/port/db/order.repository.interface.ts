...
//   searchMentoringSlots(searchFilters: SearchMentoringSlotsDtoInterface): Promise<MentoringSlot[]>;
  getAllOrders(): Promise<OrderOrm[]>;
  getOrdersBeforeDate(date:Date): Promise<OrderOrm[]>;
  getOrdersAfterDate(date:Date): Promise<OrderOrm[]>;
  getOrdersByCustomer(customer:string): Promise<OrderOrm[]>;
